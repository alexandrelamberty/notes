...
title: Ffmpeg
description: | Free and open-source software project consisting of a suite of
libraries and programs for handling video, audio, and other multimedia files
and streams 
category: Video
tags: [video,audio,sound,webcam,editing]
...
```sh
ffmpeg -f v4l2 -i /dev/video0 -preset ultrafast -vcodec libx264 -tune
...
```sh
ffmpeg -f dshow -i /dev/video0 -profile:v high -pix_fmt yuvj420p
